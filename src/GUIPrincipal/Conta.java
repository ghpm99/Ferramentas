...
public class Conta implements Serializable{
    ...
    protected Conta(String nome, String login, char[] senha,int nivel, boolean[] acesso) {
    ...
    private final int MENU = 12;
    private String nome, login;
    private int nivel;
    private char[] senha;
    private boolean[] acesso = new boolean[MENU];
    ...
    protected void setAcesso(boolean[] acesso) {
