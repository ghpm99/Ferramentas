...
public class Contas implements Serializable {
    ...
    public Contas() {
        ...
        addConta(new Conta("Convidado", "Convidado", new char[]{'1', '2', '3', '4', '5'}, 1, new boolean[]{true, true, true, true, true, true, true, true, true, true, true, true}));
        addConta(new Conta("Guilherme H.", "Guilherme", new String("").toCharArray(), 10, new boolean[]{true, true, true, true, true, true, true, true, true, true, true, true}));
