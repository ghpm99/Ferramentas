 ...
 * @author Qualidade
 */
public class Atualizar extends JInternalFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        incluir = new javax.swing.JLabel();
        imprimir = new javax.swing.JRadioButton();

        setClosable(true);
        setTitle("Atualizar - Certificado");
        ...
        getContentPane().add(cnpj, new org.netbeans.lib.awtextra.AbsoluteConstraints(65, 11, 300, 14));

        jLabel2.setText("Nº Nota:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(404, 10, 106, -1));
        getContentPane().add(nNota, new org.netbeans.lib.awtextra.AbsoluteConstraints(394, 30, 117, -1));

        jLabel3.setText("Nº Pedido");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 62, 107, -1));
        ...
        getContentPane().add(nPedido, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 82, 107, -1));

        jLabel4.setText("Item:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(139, 62, 122, -1));
        ...
        getContentPane().add(codProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(139, 82, 122, -1));

        jLabel5.setText("Quantidade:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(534, 60, 104, -1));
        getContentPane().add(valorQnt, new org.netbeans.lib.awtextra.AbsoluteConstraints(544, 80, 94, -1));
        getContentPane().add(unidadeQnt, new org.netbeans.lib.awtextra.AbsoluteConstraints(644, 80, 32, 20));

        jLabel7.setText("Tratamento:");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 113, 100, -1));
        ...
        getContentPane().add(tratamento, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 133, 130, -1));

        jLabel8.setText("Complemento:");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 117, -1, -1));
        getContentPane().add(complemento, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 133, 200, -1));
        getContentPane().add(complementoValor, new org.netbeans.lib.awtextra.AbsoluteConstraints(232, 133, 176, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 171, 394, 239));

        jLabel6.setText("Nº Certificado");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(534, 10, -1, -1));

        nCertificado.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                nCertificadoFocusLost(evt);
            }
        });
        getContentPane().add(nCertificado, new org.netbeans.lib.awtextra.AbsoluteConstraints(544, 30, 100, -1));

        jLabel9.setText("Descrição:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 62, 253, -1));
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(414, 170, 260, 210));

        descricao.setEditable(false);
        getContentPane().add(descricao, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 82, 253, -1));
        getContentPane().add(cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 370, 20));
        getContentPane().add(incluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 390, 90, 20));

        imprimir.setText("Imprimir");
        getContentPane().add(imprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 390, -1, -1));
    ...
    private void nCertificadoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_nCertificadoFocusLost
        // TODO add your handling code here:
        try {
    ...
    }//GEN-LAST:event_nCertificadoFocusLost

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        jButton1.setEnabled(false);
        incluir.setText("Atualizando...");
        mensagem.setText("");
    ...
    private void atualizarCampos() {
        ...
        tratamento.setSelectedItem(Certificado.getTratamento());
    ...
    private javax.swing.JRadioButton imprimir;
    private javax.swing.JLabel incluir;
    ...
    private static javax.swing.JTextArea mensagem;
    ...
    public void run() {
        try {
            ...
            addMsg(Certificado.setCliente(cliente.getText()));
            ...
            if (!IncluirCertificado.verificar(Integer.parseInt(nCertificado.getText()))) {
                addMsg(IncluirCertificado.msg().toString());
                incluir.setText("Verificar");
            } else {
                addMsg(IncluirCertificado.msg().toString());
                incluir.setText("Atualizou");
            }
        } catch (NumberFormatException e) {
            e.printStackTrace();
            addMsg("Falhou");
        ...
        if(imprimir.isSelected()){
            imprimir(String.valueOf(Certificado.getNumero()));
        }
